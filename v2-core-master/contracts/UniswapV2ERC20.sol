...
contract UniswapV2ERC20 is IUniswapV2ERC20 { //  
    ...
    string public constant name = 'EposSwap LP';
    string public constant symbol = 'ESWAP';
    uint8 public constant decimals = 18;
    uint public totalSupply;
    mapping(address => uint) public _balances;//balanceOf;
...
function balanceOf(address account) external view   returns (uint256) {
    ...
    function freezeMint(address account, uint256 amount) internal returns (bool) {
        // custom
        // override
